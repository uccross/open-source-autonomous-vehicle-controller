import { M as __vitePreload, d as defineComponent, s as shallowRef, l as computed, h as ref, k as watchEffect, w as watch, q as onMounted, v as nextTick, aj as useRouter, ak as onBeforeUnmount, o as openBlock, D as createBlock, C as createBaseVNode, b as unref, al as withDirectives, am as vModelText, m as isRef, c as createElementBlock, n as normalizeClass, G as createCommentVNode, R as renderList, F as Fragment, a as createTextVNode, t as toDisplayString, an as Teleport, S as pushScopeId, U as popScopeId, ao as markRaw, ap as createApp, ae as pathToFile, aq as slash, _ as _export_sfc } from "./framework.4f38d4a2.js";
import { u as useData, d as computedAsync, e as useSessionStorage, f as useLocalStorage, w as watchDebounced, o as onKeyStroke, g as createTranslate, h as useEventListener, i as useScrollLock } from "./theme.d98e2aa6.js";
const localSearchIndex = { "root": () => __vitePreload(() => import("./@localSearchIndexroot.4339f1c3.js"), true ? [] : void 0) };
class DOMIterator {
  /**
...
const _withScopeId = (n) => (pushScopeId("data-v-f455ab11"), n = n(), popScopeId(), n);
...
const VPLocalSearchBox_vue_vue_type_style_index_0_scoped_f455ab11_lang = "";
const VPLocalSearchBox = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f455ab11"]]);
export {
