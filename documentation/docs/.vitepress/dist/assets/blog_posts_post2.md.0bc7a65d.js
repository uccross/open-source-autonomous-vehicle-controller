...
const _imports_0 = "/open-source-autonomous-vehicle-controller/assets/MPLABX1.d0d35cca.png";
const _imports_1 = "/open-source-autonomous-vehicle-controller/assets/MPLABX2.4af1e6a9.png";
const _imports_2 = "/open-source-autonomous-vehicle-controller/assets/MPLABX3.33de2aa1.png";
const __pageData = JSON.parse('{"title":"Setting Up MPLAB X","description":"","frontmatter":{"title":"Setting Up MPLAB X","Author":"Carlos Espinosa","date":"2023-06-28T00:00:00.000Z","category":"Tutorial","tags":["MPLAB X","Software"]},"headers":[],"relativePath":"blog/posts/post2.md"}');
