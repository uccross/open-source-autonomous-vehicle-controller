...
function pathToFile(path) {
  ...
  {
    if (inBrowser) {
      const base = "/open-source-autonomous-vehicle-controller/";
...
const assetsURL = function(dep) {
  return "/open-source-autonomous-vehicle-controller/" + dep;
};
const seen = {};
