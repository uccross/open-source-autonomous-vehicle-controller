...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/NEO_M8N.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/NEO_M8N.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/NEO_M8N.o: NEO_M8N.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/NEO_M8N.o.d 
	@${RM} ${OBJECTDIR}/NEO_M8N.o 
	@${FIXDEPS} "${OBJECTDIR}/NEO_M8N.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DGPS_TESTING -I"../Board.X" -I"../Serial.X" -MMD -MF "${OBJECTDIR}/NEO_M8N.o.d" -o ${OBJECTDIR}/NEO_M8N.o NEO_M8N.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp=${DFP_DIR}  
...
${OBJECTDIR}/NEO_M8N.o: NEO_M8N.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/NEO_M8N.o.d 
	@${RM} ${OBJECTDIR}/NEO_M8N.o 
	@${FIXDEPS} "${OBJECTDIR}/NEO_M8N.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DGPS_TESTING -I"../Board.X" -I"../Serial.X" -MMD -MF "${OBJECTDIR}/NEO_M8N.o.d" -o ${OBJECTDIR}/NEO_M8N.o NEO_M8N.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp=${DFP_DIR}  
	
${OBJECTDIR}/_ext/36105697/Board.o: ../Board.X/Board.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/36105697" 
	@${RM} ${OBJECTDIR}/_ext/36105697/Board.o.d 
	@${RM} ${OBJECTDIR}/_ext/36105697/Board.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/36105697/Board.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DGPS_TESTING -I"../Board.X" -I"../Serial.X" -MMD -MF "${OBJECTDIR}/_ext/36105697/Board.o.d" -o ${OBJECTDIR}/_ext/36105697/Board.o ../Board.X/Board.c    -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -mdfp=${DFP_DIR}  
...
dist/${CND_CONF}/${IMAGE_TYPE}/NEO_M8N.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	...
	${MP_CC_DIR}\\xc32-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/NEO_M8N.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} 
endif
