...
ifeq "$(wildcard nbproject/Makefile-local-READ_RMC_CSV.mk)" "nbproject/Makefile-local-READ_RMC_CSV.mk"
include nbproject/Makefile-local-READ_RMC_CSV.mk
endif
endif
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-READ_RMC_CSV.mk dist/${CND_CONF}/${IMAGE_TYPE}/nmea0183v4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/2092238454/board.o: C\:/Users/ladyb/OneDrive/Documents/reboat/libraries/board.X/board.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/2092238454/board.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DREAD_RMC_CSV -I"../board.X" -I"../serial.X" -Wall -MMD -MF "${OBJECTDIR}/_ext/2092238454/board.o.d" -o ${OBJECTDIR}/_ext/2092238454/board.o C:/Users/ladyb/OneDrive/Documents/reboat/libraries/board.X/board.c    -DXPRJ_READ_RMC_CSV=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  
...
${OBJECTDIR}/_ext/191137912/serial.o: C\:/Users/ladyb/OneDrive/Documents/reboat/libraries/serial.X/serial.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/_ext/191137912/serial.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DREAD_RMC_CSV -I"../board.X" -I"../serial.X" -Wall -MMD -MF "${OBJECTDIR}/_ext/191137912/serial.o.d" -o ${OBJECTDIR}/_ext/191137912/serial.o C:/Users/ladyb/OneDrive/Documents/reboat/libraries/serial.X/serial.c    -DXPRJ_READ_RMC_CSV=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  
...
${OBJECTDIR}/_ext/2092238454/board.o: C\:/Users/ladyb/OneDrive/Documents/reboat/libraries/board.X/board.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/2092238454/board.o.d 
	@${RM} ${OBJECTDIR}/_ext/2092238454/board.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/2092238454/board.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -DREAD_RMC_CSV -I"../board.X" -I"../serial.X" -Wall -MMD -MF "${OBJECTDIR}/_ext/2092238454/board.o.d" -o ${OBJECTDIR}/_ext/2092238454/board.o C:/Users/ladyb/OneDrive/Documents/reboat/libraries/board.X/board.c    -DXPRJ_READ_RMC_CSV=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  
...
dist/${CND_CONF}/${IMAGE_TYPE}/nmea0183v4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) -g -mdebugger -D__MPLAB_DEBUGGER_PK3=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/nmea0183v4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_READ_RMC_CSV=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)   -mreserve=data@0x0:0x1FC -mreserve=boot@0x1FC02000:0x1FC02FEF -mreserve=boot@0x1FC02000:0x1FC024FF  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,-D=__DEBUG_D,--defsym=__MPLAB_DEBUGGER_PK3=1,--defsym=_min_heap_size=1024,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/nmea0183v4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/nmea0183v4.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_READ_RMC_CSV=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=_min_heap_size=1024,--no-code-in-dinit,--no-dinit-in-serial-mem,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml 
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/READ_RMC_CSV
	${RM} -r dist/READ_RMC_CSV
