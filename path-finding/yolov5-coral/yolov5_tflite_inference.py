...
class yolov5_tflite:
    ...
    def __init__(self,weights = 'yolov5s-fp16_edge.tflite',image_size = 416,conf_thres=0.25,iou_thres=0.45):

        self.weights = weights
        self.image_size = image_size
        self.conf_thres = conf_thres
        self.iou_thres = iou_thres
        self.interpreter = tflite.Interpreter(self.weights, experimental_delegates=[tflite.load_delegate('libedgetpu.so.1')])
