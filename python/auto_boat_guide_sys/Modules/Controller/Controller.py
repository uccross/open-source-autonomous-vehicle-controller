...
class PID():
    def __init__(self, dt_uc=CNST.dt_uc, kp=CNST.kp_rudder, ki=CNST.ki_rudder,
                 kd=CNST.kd_rudder, max_act_lim=CNST.max_rudder_angle,
                 min_act_lim=CNST.min_rudder_angle):
        """
        :param dt_uc: The sample time in seconds
    ...
    def update(self, commanded, measured, derivative):
        ...
        self.accumulator += 0.5*self.dt_uc*(error + self.prevError)
...
class PD():
    def __init__(self, kp=CNST.kp_rudder, kd=CNST.kd_rudder,
...
class P():
    def __init__(self, kp=CNST.kp_rudder,
                 max_act_lim=CNST.max_rudder_angle, 
                 min_act_lim=CNST.min_rudder_angle):
        """
        :param kp: Propertional gain
