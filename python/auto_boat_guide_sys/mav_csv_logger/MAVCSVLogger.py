...
class MAVCSVLogger():
    ...
    def send_mav_cmd_nav_waypoint(self, wp_lat_lon, wp_type=-1.0, yaw=0.0):
        ...
        :param wp_type: 0.0 if lla wayopint, 1.0 if en waypoint, 2.0 if HIL GPS
        """
    ...
    def send_mav_ltp_en_waypoint(self, wp_en, omega_yaw, kp, kd,
                                 prev_or_next=0.0):
        """
        ...
        self.mav_conn.mav.command_long_send(
            ...
            mavutil.mavlink.MAV_CMD_NAV_WAYPOINT,
            0,  # Hold
            kp,  # Accept Radius -> using as kp
            kd,  # Pass Radius -> using as kd
